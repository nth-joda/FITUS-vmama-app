...
const renderBodyDelete = (item, index) => {
  return (
    <tr key={index}>
      ...
      <td
        className={
          item.left > 0 ? "centering safe-txt" : "centering danger-txt"
        }
      >
        {item.left}
      </td>
...
const Vouchers = () => {
  ...
  const renderHead = (item, index) => {
    if (item === "Chọn" && checkedList.length > 0)
      return (
        <th className="white-txt chosen_num" key={index}>
          {"[ " + checkedList.length + " ]"}
        </th>
      );
    else
      return (
        <th
          className={
            index === 3 || index === 4 ? "white-txt centering" : "white-txt"
          }
          key={index}
        >
          {item}
        ...
        <td>
          <Checkbox
            ...
            onChange={(e) => {
              ...
              checkedList.filter((x) => x === checkedID).length <= 0
                ? setCheckedList([...checkedList, checkedID])
                : setCheckedList([
                    ...checkedList.filter((x) => x !== checkedID),
                  ]);
            }}
          />
        </td>
  ...
  return (
    <div className="vouchers">
      <div className="vouchers__header">
        ...
        <Updater
          catchAdd={handleAdd}
          catchDelete={handleDelete}
          catchRefresh={handleRefresh}
      ...
      >
        <Box sx={modal_Style}>
          <p className="modal__header modal__header-refresh">
            Bỏ chọn tất cả [ {checkedList.length} ] vouchers sau:
          </p>
          <div className="vouchers__content">
            <Table
      ...
      >
        <Box sx={modal_Style}>
          <p className="modal__header modal__header-delete">
            Xóa {checkedList.length} vouchers sau:
          </p>
          <div className="vouchers__content">
            <Table
              headData={voucherTableHeadDelete}
          ...
          <form>
            <div className="modal__form-field">
              ...
              <TextField
                ...
                variant="filled"
                defaultValue={
                  vList.find((x) => x.id === chosenEdit)
                    ? vList.find((x) => x.id === chosenEdit).voucher_name
                    : ""
                }
              />
            </div>
            ...
            <div className="modal__form-field">
              ...
              <TextField
                ...
                defaultValue={
                  vList.find((x) => x.id === chosenEdit)
                    ? vList.find((x) => x.id === chosenEdit).brand_name
                    : ""
                }
              />
            </div>
            ...
            <div className="modal__form-field">
              ...
              <TextField
                ...
                defaultValue={
                  vList.find((x) => x.id === chosenEdit)
                    ? vList.find((x) => x.id === chosenEdit).left
                    : ""
                }
              />
            </div>
